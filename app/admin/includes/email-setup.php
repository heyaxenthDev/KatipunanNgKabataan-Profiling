        ...
        <div class="modal-content">
            ...
            <form action="email-verification.php" method="POST">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" name="sendVerification" id="resetRequestCode">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response === "taken") {
                        ...
                        $("#resetRequestCode").prop("disabled", true); // Disable button
                    } else {
                        $("#email").addClass("is-valid").removeClass("is-invalid");
                        $("#emailFeedback").html(
                            '<span class="text-success">This email is available.</span>'
                        );
                        $("#resetRequestCode").prop("disabled", false); // Enable button
                    }
                }
            });
        } else {
