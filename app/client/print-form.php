        ...
        <form class="card-body" action="submit-form.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    <div class="text-center">
                        <div class="border-dark border-bottom">
                            <input type="text" class="form-control border-0" id="FirstName" name="firstName" required>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="text-center">
                        <div class="border-bottom border-dark">
                            <input type="text" class="form-control border-0" id="MiddleName" name="middleName" required>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="text-center">
                        <div class="border-bottom border-dark">
                            <input type="text" class="form-control border-0" id="inputBirthdate" name="inputBirthdate"
                                required>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="skVoter" id="skVoterYes" value="Yes"
                                    required>
                                <label class="form-check-label" for="skVoterYes">Yes</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="skVoter" id="skVoterNo" value="No">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="nationalVoter" id="nationalVoterYes"
                                    value="Yes" required>
                                <label class="form-check-label" for="nationalVoterYes">Yes</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="nationalVoter" id="nationalVoterNo"
                                    value="No">
